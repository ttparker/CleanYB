...
function MCSweep!(system::Yb, measure::Bool)
  ...
  for step = 1:system.N
    ...
    DeltaE = dot(DeltaS, system.Ja1 * (system.spins[se, ne, :] + system.spins[nw, sw, :]) + system.Ja2 * (system.spins[nw, n3, :] + system.spins[se, n3, :]) + system.Ja3 * (system.spins[n2, sw, :] + system.spins[n2, ne, :]))
